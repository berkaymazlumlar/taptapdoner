...
abstract final class CustomerOrderCatalog {
  ...
  static const customerTypes = <CustomerTypeDefinition>[
    ...
    CustomerTypeDefinition(
      id: goldenCustomer,
      nameEn: 'Golden Customer',
      nameTr: 'Altin Musteri',
      behavior: 'Golden Doner linked order',
      primaryReward: 'Large reward',
  ...
  static const templates = <CustomerOrderTemplate>[
    CustomerOrderTemplate(
      ...
      titleTr: 'Basit Doner Siparisi',
      descriptionEn: 'Cut 15 doners.',
      descriptionTr: '15 doner kes.',
    ...
    CustomerOrderTemplate(
      ...
      titleEn: 'Rush Order',
      titleTr: 'Acele Siparis',
      descriptionEn: 'Cut 25 doners in 10 seconds.',
      descriptionTr: '10 saniye icinde 25 doner kes.',
      objectiveType: OrderObjectiveType.tapCount,
      targetValue: 25,
      durationSeconds: 10,
      minReputationLevel: 2,
    ...
    CustomerOrderTemplate(
      ...
      titleTr: 'Dolu Tepsi Siparisi',
      descriptionEn: 'Earn cash for this customer.',
      descriptionTr: 'Bu musteri icin para kazan.',
    ...
    CustomerOrderTemplate(
      ...
      descriptionTr: '30 saniye icinde 50 doner kes.',
      objectiveType: OrderObjectiveType.tapCount,
      targetValue: 50,
      durationSeconds: 30,
      minShopLevel: 2,
    ...
    CustomerOrderTemplate(
      id: 'golden_collect_1',
      customerTypeId: goldenCustomer,
      titleEn: 'Golden Taste',
      titleTr: 'Altin Lezzet',
      descriptionEn: 'Collect 1 Golden Doner.',
      descriptionTr: '1 Altin Doner yakala.',
      objectiveType: OrderObjectiveType.collectGoldenDoner,
      targetValue: 1,
      durationSeconds: 45,
      minShopLevel: 2,
      minReputationLevel: 7,
      ...
      weight: 0.8,
      rewards: [
        OrderRewardSpec(type: OrderRewardType.money, passiveIncomeSeconds: 240),
        OrderRewardSpec(type: OrderRewardType.reputation, amount: 8),
      ],
    ),
    CustomerOrderTemplate(
      ...
      descriptionTr: 'Video bitmeden 40 doner kes.',
      objectiveType: OrderObjectiveType.tapCount,
      targetValue: 40,
      durationSeconds: 25,
      minShopLevel: 3,
...
String orderObjectiveTypeKey(OrderObjectiveType type) {
  return switch (type) {
    ...
    OrderObjectiveType.useTurbo => 'use_turbo',
    OrderObjectiveType.collectGoldenDoner => 'collect_golden_doner',
...
OrderObjectiveType orderObjectiveTypeFromKey(String key) {
  return switch (key) {
    ...
    'use_turbo' => OrderObjectiveType.useTurbo,
    'collect_golden_doner' => OrderObjectiveType.collectGoldenDoner,
...
String orderRewardTypeKey(OrderRewardType type) {
  return switch (type) {
    ...
    OrderRewardType.turboCharge => 'turbo_charge',
...
OrderRewardType orderRewardTypeFromKey(String key) {
  return switch (key) {
    ...
    'turbo_charge' => OrderRewardType.turboCharge,
